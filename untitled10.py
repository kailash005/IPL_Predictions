...
Original file is located at
    https://colab.research.google.com/drive/1tr6Fd3sNV6okdlDXZbdWXtvIo4ITt1Mj
"""
...
teams = pd.concat([matches['team1'], matches['team2']]).unique()  # Combine team1 and team2 to get all teams
...
X = data.drop(columns=['winner', 'dl_applied', 'win_by_runs', 'win_by_wickets'])  # Features
